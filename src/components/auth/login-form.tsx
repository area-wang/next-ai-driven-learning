  ...
  return (
    <Card variant="glass" className={cn("w-full max-w-md", className)}>
      <CardHeader className="text-center">
        ...
        <CardDescription>登录您的账户继续学习</CardDescription>
      </CardHeader>
      <CardContent>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white/80 text-[var(--color-text-secondary)]">或</span>
          </div>
        </div>
      ...
      <CardFooter className="justify-center">
        <p className="text-sm text-[var(--color-text-secondary)]">
          还没有账户？{" "}
          <a href="/auth/register" className="text-[var(--color-primary)] hover:underline cursor-pointer">
            立即注册
          </a>
        </p>
      </CardFooter>
